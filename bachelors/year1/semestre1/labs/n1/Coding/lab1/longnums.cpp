...
struct TLong
{
    ...
    string ToStr ();
    void Input(string fname, int bs);
    ...
    TLong Power_Abs(TLong a,TLong b);
    TLong Power(TLong a,TLong b,int k);
...
void TLong::Input(string fname, int bs)
{
...
void TLong::Output(string fname)
{
...
TLong TLong::Power_Abs(TLong a, TLong b)
{
    TLong res;
    res.n[nmax]=1;
    res.bracket=0;
...
TLong TLong::Power(TLong a, TLong b,int k)
{
    TLong O,r;
    if (b.sign=='-')
    {
