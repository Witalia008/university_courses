...
Node_data print(vector<Node_data> &args) {
...
Node_data scan(vector<Node_data> &args) {
    bool success = true;
...
Node_data operator_add(Node_data arg0, int delta, bool left) {
    ...
    if (arg0.type == Variable) {
        variable_value(*arg0.var_val, *arg0.str_val);
    }
...
Node_data operator_semicolon(Node_data arg0, Node_data arg1) {
    Node_data res = arg1;
    if (arg0.type == Oper && *arg0.str_val == "return") {
        res = arg0;
    }
    return res;
}
