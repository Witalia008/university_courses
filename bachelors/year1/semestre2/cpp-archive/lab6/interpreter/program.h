...
public:
    ...
    Program(string file) {
        ...
        funcs.push_back(Function("break", break_func));
        ...
        opers.push_back(Operator(0, "<", operator_less, Operator::Little));
        opers.push_back(Operator(0, ">", operator_bigger, Operator::Little));

        opers.push_back(Operator(1, "==", operator_equalx2, Operator::Big));
        opers.push_back(Operator(0, "!=", operator_not_equal, Operator::Big));
        opers.push_back(Operator(0, "<=", operator_less_equal, Operator::Big));
        opers.push_back(Operator(0, ">=", operator_bigger_equal, Operator::Big));
        ...
        opers.push_back(Operator(0, "do", operator_void, Operator::Little));

        opers.push_back(Operator(1, "?", ":", operator_if));
        opers.push_back(Operator(0, "if", "else", operator_if));
        opers.push_back(Operator(0, ":", "to", operator_if));
