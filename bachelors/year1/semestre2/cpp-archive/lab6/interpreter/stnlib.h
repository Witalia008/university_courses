...
Node_data operator_less(Node_data, Node_data);
Node_data operator_less_equal(Node_data, Node_data);
Node_data operator_bigger(Node_data, Node_data);
Node_data operator_bigger_equal(Node_data, Node_data);
