...
public class ControlPanel extends Frame {
    ...
    Label counterLabel = new Label("0", Label.LEFT);
    ...
    public void init(Kernel useKernel, String commands, String config) {
        ...
        counterLabel.reshape(395, 240 + 25, 230, 15);
        add(counterLabel);
        ...
        Label countLbl = new Label("Counter: ", Label.LEFT);
        countLbl.reshape(285, 240 + 25, 110, 15);
        add(countLbl);
    ...
    public void paintPage(Page page) {
        ...
        counterLabel.setText(Long.toString(page.counter, 2));
    }
