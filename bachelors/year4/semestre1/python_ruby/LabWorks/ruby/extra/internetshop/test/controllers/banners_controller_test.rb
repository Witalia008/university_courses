...
class BannersControllerTest < ActionController::TestCase
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post :create, banner: { image_link: @banner.image_link, link: @banner.link, priority: @banner.priority, width: @banner.width }
    end
  ...
  test "should update banner" do
    patch :update, id: @banner, banner: { image_link: @banner.image_link, link: @banner.link, priority: @banner.priority, width: @banner.width }
    assert_redirected_to banner_path(assigns(:banner))
  end
